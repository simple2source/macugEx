...
def sql_main(source='', job_dict='', url='', job_id=''):
    ...
    # print job_dict['job_name'], job_dict['job_addr'], job_dict['job_low'], job_dict['job_high'],\
    #            job_dict['job_des'], job_dict['job_type']

    sql_up = ''' update {} SET job_name='{}',job_addr='{}',job_low='{}',job_high='{}',
    ...
    where  job_id='{}'
    '''.format(source, job_dict['job_name'], job_dict['job_addr'], job_dict['job_low'], job_dict['job_high'],
               ...
               job_dict['company_inurl'], job_dict['email'], job_dict['phone'], url, job_dict['company_id'], job_id)

    sql_in = '''insert into {} (job_url,job_name,job_addr,job_low,job_high,job_des,job_type,job_area,job_year,
...
def sql_select(source='', job_id=''):
    ...
    sql = """select job_id from {} WHERE job_id ='{}' """.format(source, job_id)
    db = sqlite3.connect('test.db')
    cursor = db.cursor()
    sql_cr = ''' create table If not EXISTS {}
            (
