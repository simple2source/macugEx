...
admin.controller('watch_info', function ($scope, $q, $rootScope, $http) {
    ...
    $scope.field = ['_id', 'maketime', 'lasttime', 'mac', 'authcode', 'status', 'group_id', 'name', 'phone', 'software_v'];
    ...
    $scope.getRecords = QueryRecord($scope, $http, '/admin/watch');
...
admin.controller('user_info', function ($scope, $q, $rootScope, $http) {
    ...
    $scope.field = ['_id', 'session', 'name', 'image_id', 'phone', 'group_id', 'maketime'];
    $scope.searchRecords = function () {
        if (!$scope.user_id) {
            $scope.query = {};
        } else {
...
admin.controller('group_info', function ($scope, $q, $rootScope, $http) {
    ...
    $scope.field = ['_id', 'name', 'brief', 'users', 'devs', 'contacts', 'maketime'];
    $scope.searchRecords = function () {
        if (!$scope.group_id) {
            $scope.query = {};
        } else {
